...
fn stash_show_summary_formats_match_git() {
    ...
    for args in [
        ...
        vec!["stash", "show", "--compact-summary", "--no-compact-summary"],
        vec!["stash", "show", "--no-compact-summary", "--compact-summary"],
...
fn stash_show_diff_passthrough_options_match_git() {
    ...
    for args in [
        ...
        vec!["stash", "show", "--patch", "--ignore-space-change"],
        vec!["stash", "show", "--patch", "--ignore-space-at-eol"],
        vec!["stash", "show", "--patch", "--ignore-cr-at-eol"],
        ...
        vec!["stash", "show", "--submodule"],
        vec!["stash", "show", "--submodule=short"],
        vec!["stash", "show", "--submodule=log"],
        vec!["stash", "show", "--submodule=diff"],
    ...
    let git_show = run_capture("git", ["stash", "show", "--submodule=bad"], &git_repo);
    let rit_show = run_capture(
        rit_binary(),
        ["stash", "show", "--submodule=bad"],
        &rit_repo,
    );
    assert_eq!(git_show.exit_code, rit_show.exit_code);
    assert_eq!(git_show.stdout, rit_show.stdout);
