...
- [~] `rit stash`
  ...
  - [ ] `stash export/import`,
    `--all` ignored-file mode, packed stash ref cleanup, same-path
    staged+unstaged `--staged` cleanup failure parity, `--index`, untracked
    apply/pop restoration, broader show options, broader error parity, and
