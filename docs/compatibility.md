...
- Cached diff supports staged rename/copy detection with `-M[<n>]`,
  ...
  copy and hard-copy slices rather than forcing extra copy promotion.
- Default worktree diff already performs checked exact rename detection for
  ...
  the covered default worktree copy and hard-copy slices instead of forcing
  extra copy promotion.
